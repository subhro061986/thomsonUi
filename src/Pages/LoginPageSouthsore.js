                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 bg-white bor_rad left_form">
                            <div className="card-body my-4">
                                ...
                                <div className="d-flex justify-content-center mt-2"><button className="buy_btn" onClick={doLogin}>Sign In</button></div>
                                ...
                                {/* <div className="d-flex justify-content-center mt-4"><button className="btn btn-outline-secondary rounded-pill d-flex align-items-center signin_txt d-flex justify-content-between">Sign In With<img src={google} /></button></div> */}
                                <div className="d-flex align-items-baseline form_footer mt-5">Don't have an account?<Link className="fw600 fc097EDA" to="/registrationsouthshore"> Sign Up</Link></div>
                            </div>
                        </div>
                    </div>
                </div>
...
export default LoginPageSouthsore;