...
const Invoice = () => {
  ...
  const { get_single_publisher_invoice } = AdminProfile()
  ...
  const getInvoiceData = async () => {
    ...
    let resp = await get_single_publisher_invoice(data)
                ...
                <tr>
                    ...
                    <td colspan="3" width="50%" style="vertical-align:top;">
                        <div style="text-align:right;padding:5px;border:0;">
                            ...
                            ${invoice.publishercity} - ${invoice.publisherpincode} 
        ...
        <div className="bg-white p-3 m-3 rounded-2 ">
          <div className="customer_sales_card1">
            ...
            <div className="ms-4 mt-3">
              <button className="btn btn-main" onClick={submitData} style={{width:'110%'}}>
        ...
        <div className="m-3">
          <table className="table bg-white">
            ...
            <tbody className="text-center">
              {/* {pubisherInvoices} */}
              {pubisherInvoices &&  pubisherInvoices.map((invoice, index) => (
                (
